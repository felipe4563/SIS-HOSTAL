  ...
  return (
    <div className="p-6">
      ...
      <div className="flex border-b mb-4">
        {[
          { id: "usuarios", label: "👥 Usuarios", visible: true },
          {
            id: "formulario",
            label: "📝 Registrar Usuario",
            visible: tienePermiso("usuario.crear") || tienePermiso("usuario.editar"),
          },
        ]
      ...
      {activeTab === "formulario" && (tienePermiso("usuario.crear") || tienePermiso("usuario.editar")) && (
