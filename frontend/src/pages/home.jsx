...
import ModalCarrito from '../pages/Home/ModalCarrito'; // 👈 NUEVO
import BotonCarrito from '../pages/Home/BotonCarrito'; // 👈 NUEVO
...
function Home() {
  ...
  const [mostrarModalCarrito, setMostrarModalCarrito] = useState(false); // 👈 NUEVO
  ...
  // 👇 NUEVO: Handler para reservas múltiples exitosas
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-amber-50">
      ...
      {/* 👇 NUEVO: MODAL DE CARRITO (RESERVAS MÚLTIPLES) */}
      {mostrarModalCarrito && (
        <ModalCarrito
